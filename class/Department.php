...
class Department extends Database {  
	...
	public function listDepartment(){
		...
		while( $department = mysqli_fetch_assoc($result) ) {		
			...
			$departmentRows[] = '<button type="button" name="update" id="'.$department["id"].'" class="btn btn-warning btn-xs update">Editar</button>';
			$departmentRows[] = '<button type="button" name="delete" id="'.$department["id"].'" class="btn btn-danger btn-xs delete">Eliminar</button>';
