	...
	public function listUser(){
		...
		while( $user = mysqli_fetch_assoc($result) ) {		
			...
			if($user['user_type'] == 'admin')	{
				...
				$userRole = '<span class="label label-warning">Miembro</span>';
			}	
			...
			$userRows[] = '<button type="button" name="update" id="'.$user["id"].'" class="btn btn-warning btn-xs update">Editar</button>';
			$userRows[] = '<button type="button" name="delete" id="'.$user["id"].'" class="btn btn-danger btn-xs delete">Borrar</button>';
			$userData[] = $userRows;
		}
		$output = array(
